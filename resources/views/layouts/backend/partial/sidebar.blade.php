        ...
        <div class="info-container">
            ...
            <div class="btn-group user-helper-dropdown">
                ...
                <ul class="dropdown-menu pull-right">
                    ...
                    <li>
                        <a href="{{ Auth::user()->role_id == 1 ? route('admin.settings') : route('author.settings')}}"><i class="material-icons">settings</i>Settings</a>
                    </li>
    ...
    <div class="legal">
        <div class="copyright">
            ...
            <strong> Developed &amp; <i class="far fa-heart"></i> by </strong>
                        <a href="https://www.bubt.edu.bd" target="_blank">BUBT TEAM</a>.
        </div>
        {{-- <div class="version">
            <b>Version: </b> 1.0.5
        </div> --}}
